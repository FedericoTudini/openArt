        ...
        return (
            <View style={{height: Dimensions.get('window').height, width: Dimensions.get('window').width, backgroundColor: '#ffffff'}}>
                ...
                <ScrollView style={styles.scrollContainer}>
                    <ImageBackground style={styles.img} source={this.props.path} >
                        <TouchableOpacity style={{position : 'absolute', top: 20, right: 20}}>
                            <FontAwesomeIcon icon={faExpandAlt} size={25} color={"white"}/>
                        </TouchableOpacity>
                    </ImageBackground>
                    <LinearGradient 
                        ...
                        <View style={{marginBottom: 15}}>
                            <Text style={styles.txt}>Titolo: {this.props.name}</Text>
                            <Text style={styles.txt}>Artista: {this.props.artist}</Text>
                        </View>
